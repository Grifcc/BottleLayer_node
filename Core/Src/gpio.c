...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PA0 PA1 PA8 PA11 PA12 */
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_8|GPIO_PIN_11|GPIO_PIN_12;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  ...
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
	...
	/*Configure GPIO pin : PA6  PA7 PA15*/
  GPIO_InitStruct.Pin = GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
	
	/*Configure GPIO pin : PB12  PB3 PB4 PB5 PB6 PB7*/
